...
public static class Configuration
{
	...
	internal class UIXIntegration
	{
		...
		{
			ExpansionKitApi.RegisterSettingAsStringEnum(Category.Identifier, TabAlignment.Identifier, new List<(string, string)>
			{
				("Left", "Left"),
				("Center", "Center"),
				("Right", "Right")
	...
	public static void Init()
	{
		...
		if (MelonHandler.Mods.Any((MelonMod mod) => mod.Info.Name.Equals("UI Expansion Kit")))
		{
